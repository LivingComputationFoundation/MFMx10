...
set terminal pngcairo  background "#000000" enhanced fontscale 2.5 size 1920, 1080
...
set border 31 front lt black linewidth 3.000 dashtype solid
set cornerpoles
set zdata 
set ydata 
set xdata time
...
VoxelDistance = 0.0
GridDistance = 0.0
FILE = "../../bin/riscv10-builds.dat"
## Last datafile plotted: "../../bin/riscv10-builds.dat"
plot FILE using 1:($5/1024) w lp lw 3
#    EOF
