...
#            breakpoint()
    ...
    def predeclareSpecialUClasses(self):
        pass
        # uuc = self.ucf.getUClass('UrSelf')
        # uuc.configureClass({ 'type' : 'quark',
        #                      })
        # euc = self.ucf.getUClass('Empty')
        # euc.configureClass({ 'type' : 'element',
        #                      'is' : 'UrSelf'
        #                      })

    def declareAllUClasses(self):
        self.predeclareSpecialUClasses();
        ccfg = self.codeCfg
